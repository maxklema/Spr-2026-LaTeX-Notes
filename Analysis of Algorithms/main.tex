...
DSelect works OK in practice, but is not competitive with RSelect. The reason is that there is larger constant factors in the running time. The other reason is because the \textbf{deterministic approach requires additional memory}.
